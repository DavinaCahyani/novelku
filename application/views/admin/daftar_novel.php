        ...
        <div class="flex-1 overflow-x-hidden overflow-y-auto bg-white">
            ...
            <nav class="bg-blue-500 p-4 fixed w-full z-10">
                <div class="container mx-auto flex items-center justify-between">
                    ...
                    <!-- Navbar Brand -->
                    <h1 class="text-2xl font-bold text-white ml-4 md:ml-0">Daftar Novel</h1>
                </div>
            </nav>
            ...
            <div class="overflow-x-auto p-5 m-5 shadow-xl rounded-xl mt-20">
                ...
                <table id="example" class="min-w-full rounded-md p-6 border border-gray-300 mt-3 stripe hover"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-black justify-center flex gap-3">
